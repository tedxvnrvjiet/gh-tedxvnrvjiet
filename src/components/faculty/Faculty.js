...
import Rishitha from '../../assets/team/ishi 23.png'
...
{ url:Tarun,
  ...
  return (
    <div className='mt-20 profile'>
      ...
      <div class="flex flex-col md:flex-row justify-center align-center">
        {
          tech.map((ar,index)=><FacultyMems key={index} ar={ar}/>)
        }
      </div>
