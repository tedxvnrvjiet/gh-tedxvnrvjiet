...
function Previousthemes() {
  ...
  return (
    <div style={{position:"relative"}}>
        <div className='mobile:pt-8 lg:pt-16 pr-6 grid md:grid-row-2 lg:grid-cols-4  lg:grid-row-0 md:divide-x-0 lg:divide-x-2 divide-gray-500 '>
            <div>
            {/* <hr className='border-0 h-1 ml-14 mb-4 rounded w-1/6  bg-white'/> */}
                <div className='sticky top-24 gap-4 mobile:pl-10 lg:pl-20 lg:pr-8 grid md:grid-row-3 lg:grid-row-0 '>
